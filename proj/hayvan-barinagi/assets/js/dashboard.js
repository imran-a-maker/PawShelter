/**
 * PawShelter – Dashboard Logic (En Güncel ve Birleştirilmiş Hali)
 * Handles: RBAC access control, stat count-up animation, canvas bar chart, activity feed
 */

// ── 1. Rol Bazlı Erişim ve Profil Kontrolü ─────────────────────────────────────
(function checkDashboardAccess() {
  ...
  // Eğer giriş yapan kişi admin değilse body'ye kısıtlama sınıfını ekle
  if (user.role !== 'admin') {
    document.body.classList.add('is-user'); // HTML'deki CSS kural mimarisini tetikler
...
// ── 4. Aktivite Akışı (Activity Feed) ────────────────────────────────────────
const activities = [
